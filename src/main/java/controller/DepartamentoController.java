...
import modelo.dao.DepartamentoFacade;
...
public class DepartamentoController implements Serializable {
    ...
    @EJB
    private modelo.dao.DepartamentoFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Vista").getString("DepartamentoCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Vista").getString("DepartamentoUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Vista").getString("DepartamentoDeleted"));
        if (!JsfUtil.isValidationFailed()) {
